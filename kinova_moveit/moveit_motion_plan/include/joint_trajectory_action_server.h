...
namespace kinova
{
    ...
    private:
        ...
        control_msgs::FollowJointTrajectoryActionFeedbackConstPtr last_controller_state_;
        ...
        void controllerStateCB(const control_msgs::FollowJointTrajectoryActionFeedbackConstPtr &msg);
